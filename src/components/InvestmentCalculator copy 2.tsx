...
export default function InvestmentCalculator() {
  ...
  const calculateTotal = () => {
    const rate = 0.05; // 5% monthly ROI
    return investment * Math.pow(1 + rate, months);
  };

  return (
    <section
      className="w-full px-6 py-16 bg-brand-purple-700 scrollbar-hide"
      id="calculator"
    >
      <div className="max-w-4xl mx-auto">
        {/* Initial Investment */}
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-lg font-medium text-brand-purple-100">
            Initial investment
          </h3>
          <div className="text-2xl font-bold text-brand-purple-100">
