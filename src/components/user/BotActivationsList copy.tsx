// import { BotActivation } from "@prisma/client";

interface Props {
  activations:{ id: string; active: boolean; startedAt: Date; bot: { id: string; name: string; tier: string; performance: string; }; }[];
}
          ...
          {activations.map((act) => (
            ...
            >
              <div>
                ...
                <p className="text-sm text-brand-slate-500">Started: {new Date(act.startedAt).toLocaleDateString()}</p>
