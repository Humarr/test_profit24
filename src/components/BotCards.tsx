    ...
    return (
        <section className="w-full px-6 my-16 bg-white" id="bots">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-6">
                {/* Left Card */}
                <div className="flex-1 bg-[#f3e8ff] text-brand-slate-500 p-8 rounded-2xl shadow-md">
                ...
                {/* Right Card */}
                <div className="flex-1 bg-brand-purple-500 text-brand-white p-8 rounded-2xl shadow-md">
                    <h3 className="text-2xl font-bold font-sans mb-4">The Bots</h3>
                    <p className="text-base font-sans leading-relaxed">
